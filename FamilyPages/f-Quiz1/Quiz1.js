...
const right_ans_que_r = document.querySelector(".right-ans span");
const wrong_ans_que_r = document.querySelector(".wrong-ans span");
...
next_btn.onclick = () => {
    ...
    if(questions.length > que_index){
        ...
        right_ans_que_r.innerText = right_answers;
        wrong_ans_que_r.innerText = wrong_answers;
        percentage.innerText = ((right_answers*100)/questions.length).toFixed(1)+ " %";
