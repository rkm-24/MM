...
const endGame = () => {
    ...
    modalContent.classList.add("modal-wrong");
    modalText.innerHTML = `
    <centre><br>Time off! <b>${correctWord.toUpperCase()}</b> was the correct word.
    <br>You Lost The Game ! :(</centre><br>
    </centre>
    `;
...
const winGame = () => {
    ...
    modalText.innerHTML = `<br><centre>Congrats You WIN THE GAME !!!!!!</centre>`;
